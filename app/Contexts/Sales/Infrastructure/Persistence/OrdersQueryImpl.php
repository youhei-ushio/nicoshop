...
final class OrdersQueryImpl implements OrdersQuery
{
    private int $perPage = 1000;
    private int $currentPage = 1;
    private bool $withoutFinished = false;

    public function withoutFinished(): OrdersQuery
    {
        $this->withoutFinished = true;
        return $this;
    }

    public function paginate(int $perPage, int $currentPage): OrdersQuery
    {
